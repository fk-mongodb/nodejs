/**
 * @fileoverview Demonstrate find one and update operation to MongoDB Atlas Cluster
 * 
 * @description
...
async function crud(client) {
    ...
    const resultUpdate = await devices.findOneAndUpdate(filter, updateDoc, options);
