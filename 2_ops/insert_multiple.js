/**
 * @fileoverview Demonstrate insert multiple operation to MongoDB Atlas Cluster
 * 
 * @description
 * Demonstrate insert multiple operation to MongoDB Atlas Cluster
 * 
...
async function crud(client) {
    ...
    const result = await devices.insertMany(data);
