/**
 * @fileoverview Demonstrate Basic find one and delete operation to MongoDB Atlas Cluster
 * 
 * @description
 * Demonstrate Basic delete one operation to MongoDB Atlas Cluster
 * 
...
async function crud(client) {
    ...
    const resultDelete = await devices.findOneAndDelete({ _id: resultInsert.insertedId });
